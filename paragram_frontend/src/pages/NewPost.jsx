  ...
  return (
    <div>
      <div>
        ...
        <p>Share what's on your mind. It's safe here.</p>
          ...
          <div className="flex-1 space-y-6 ">
            <div>
              ...
              <div className="mt-2 flex justify-between items-center">
                {/* Reserved for future character counter */}
                <p className="text-xs text-gray-500"></p>

                {/* Warning snackbar for empty post */}
                {open ? (
                  state_msg === "warning" ? (
                    <SnackbarMessage
                      openstatus={open}
                ...
                {/* Success snackbar after successful post */}
                {open ? (
                  state_msg === "success" ? (
                    <SnackbarMessage
                      openstatus={open}
